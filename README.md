...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/openff-nagl-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openff-nagl-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add openff-nagl openff-nagl-base
# for installing globally
pixi global install openff-nagl openff-nagl-base
```
...
It is possible to list all of the versions of `openff-nagl` available on your platform:
...
```
pixi search openff-nagl --channel conda-forge
```
